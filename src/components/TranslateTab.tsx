...
interface TranslateTabProps {
  ...
  setTranslateInput: React.Dispatch<React.SetStateAction<string>>;
  translateImage: string | null;
  setTranslateImage: React.Dispatch<React.SetStateAction<string | null>>;
  targetLang: Language;
  setTargetLang: (lang: Language) => void;
  isSummaryMode: boolean;
  setIsSummaryMode: (isSummary: boolean) => void;
  translateInputWithInterim: string;
  matchedTerms: VocabItem[];
  getVocabTranslation: (item: VocabItem, lang: Language) => string;
  handleTranslate: (isAuto?: boolean) => Promise<void>;
  loading: boolean;
  ...
  triggerDebouncedAutoTranslate: () => void;
  state: AppState;
  isSpeaking: boolean;
  isCopied: boolean;
  isCached: boolean;
