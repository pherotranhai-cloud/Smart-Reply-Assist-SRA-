...
interface ComposeTabProps {
  composeReq: string;
  setComposeReq: React.Dispatch<React.SetStateAction<string>>;
  ...
  setComposeParams: React.Dispatch<React.SetStateAction<{
    audience: Audience;
    tone: Tone;
    length: Length;
    lang: Language;
  ...
  useContextInCompose: boolean;
  setUseContextInCompose: (use: boolean) => void;
  context: ConversationContext | null;
  isListening: boolean;
  composeInputWithInterim: string;
  state: AppState;
  isSpeaking: boolean;
  loading: boolean;
  handleCompose: () => Promise<void>;
